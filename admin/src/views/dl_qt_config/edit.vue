    ...
    <div class="edit-popup">
        ...
        >
            <el-form ref="formRef" :model="formData" label-width="90px" :rules="formRules">
                <el-form-item label="取款方式" prop="type">
					<el-select
                ...
                <el-form-item label="账户名称" prop="ju_card">
    <el-input v-model="formData.ju_card" clearable placeholder="请输入账户名称" />
</el-form-item>
                <el-form-item label="账户" prop="card">
    <el-input v-model="formData.card" clearable placeholder="请输入账户" />
</el-form-item>
